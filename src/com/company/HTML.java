...
/*
 * This class is created to read the HTML.CSV file which contains  questions and answers for HTML quiz
 */

public class HTML {
    int total;
    String filename = "HTML.CSV";  /* to import CSV File  */

    File file = new File (filename);
    int constant = 0;
    public int html() {   /* a new method is created */
